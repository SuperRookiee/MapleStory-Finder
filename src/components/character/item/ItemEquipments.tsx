                            ...
                            return (
                                <Popover key={slot}>
                                    <PopoverTrigger asChild>
                                        <div
                                            className="border rounded-md flex items-center justify-center bg-card cursor-pointer transition-transform duration-150 hover:shadow-md hover:scale-[1.02]"
                                            style={{
                                                ...slotStyle,
