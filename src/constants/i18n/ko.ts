export const ko = {
    ...
    checkList: {
        ...
        weekly: {
            title: "주간 보스 체크",
            description: "주요 지역별 주간 보스 진행 상황을 한눈에 확인할 수 있어요.",
            resetInfo: "매주 목요일 00시에 초기화됩니다.",
            summary: {
                clears: "이번 주 클리어",
                total: "총 {value}회 진행 가능",
                reward: "예상 수익",
                rewardHint: "수치는 보스 기본 메소 기준입니다.",
                progress: "완료율",
                progressHint: "이번 주에 클리어한 보스 비율",
            },
        ...
        monthly: {
            subtitle: "월간 보스",
            description: "검은마법사는 월 1회만 도전할 수 있어요.",
            reward: "보상: {value}",
            hint: "월간 보스는 매월 1일에 초기화됩니다.",
            reset: "다음 달 초기화 시 다시 체크할 수 있어요.",
            status: {
                done: "이번 달 완료",
                todo: "이번 달 진행하기",
            },
        ...
        dashboard: {
            ...
            groupStats: {
                title: "지역별 현황",
                description: "지역별 클리어 현황과 예상 수익입니다.",
                subtitle: "{cleared}/{total} 완료",
                reward: "예상 수익",
            },
            monthly: {
                title: "월간 진행 기록",
                description: "최근 6개월 동안의 월간 보스 클리어 여부입니다.",
                cleared: "완료",
                notCleared: "미완료",
                status: "상태",
                barLabel: "검은마법사 진행",
                summary: "최근 기록에서 {boss}를 {value, plural, one {한 번} other {#번}} 완료했어요.",
            },
        },
    },
    search: {
