export const ko = {
    ...
    todoList: {
        ...
        calendar: {
            ...
            dialog: {
                ...
                repeatWeeklyLabel: "매주 추가",
                repeatWeeklyDescription: "체크하면 같은 요일에 매주 자동으로 일정이 등록돼요.",
                repeatUntilLabel: "반복 종료 날짜",
                repeatUntilHelp: "마지막으로 일정을 추가할 날짜를 선택하세요.",
                dateLabel: "날짜",
    ...
    notice: {
        title: "메이플스토리 공지 모음",
        description: "최근 공지사항, 업데이트 노트, 진행 중 이벤트를 한곳에서 확인하세요.",
        tabs: {
            notice: "공지사항",
            update: "업데이트",
            event: "이벤트",
