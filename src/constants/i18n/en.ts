export const en = {
    ...
    todoList: {
        ...
        weekly: {
            ...
            description: "Check progress for each region's weekly bosses at a glance.",
            resetInfo: "Resets every Thursday at 00:00.",
            summary: {
                clears: "Clears this week",
                total: "Up to {value} runs available",
                reward: "Projected reward",
                rewardHint: "Calculated with the base meso reward.",
                progress: "Completion rate",
                progressHint: "Share of tracked bosses cleared this week",
            },
        ...
        monthly: {
            subtitle: "Monthly boss",
            description: "The Black Mage can only be challenged once per month.",
            reward: "Reward: {value}",
            hint: "Monthly bosses reset on the first day of each month.",
            reset: "You can mark it again after the reset.",
            status: {
                done: "Completed this month",
                todo: "Challenge this month",
            },
        },
        toast: {
        ...
        dashboard: {
            cards: {
                ...
                monthly: {
                    ...
                    description: "Black Mage activity",
            ...
            groupStats: {
                ...
                description: "Completion status and projected reward by region.",
                subtitle: "{cleared}/{total} cleared",
                reward: "Projected reward",
            },
            monthly: {
                title: "Monthly history",
                description: "Black Mage progress over the last six months.",
                cleared: "Cleared",
                notCleared: "Not cleared",
                status: "Status",
                barLabel: "Black Mage",
                summary: "{boss} has been cleared {value, plural, one {once} other {# times}} in the latest records.",
            },
        },
    },
    search: {
