    ...
    todoList: {
        ...
        calendar: {
            ...
            dialog: {
                ...
                repeatWeeklyLabel: "Add every week",
                repeatWeeklyDescription: "Create the same event on this weekday until the end date.",
                repeatUntilLabel: "Repeat until",
                repeatUntilHelp: "Select the last day to create the recurring event.",
                dateLabel: "Date",
